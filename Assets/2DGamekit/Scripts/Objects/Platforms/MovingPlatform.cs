...
namespace Gamekit2D
{
    ...
    public class MovingPlatform : MonoBehaviour
    {
        ...
        [FMODUnity.EventRef]
        public string PlatformMovingEvent = "";
        FMOD.Studio.EventInstance movingplatform;
        ...
        protected void Init()
        {
            ...
            if (isMovingAtStart)
            {
                ...
                m_Started = false;
            movingplatform = FMODUnity.RuntimeManager.CreateInstance(PlatformMovingEvent);
        }
        ...
        private void FixedUpdate()
        {
            ...
            movingplatform.set3DAttributes(FMODUnity.RuntimeUtils.To3DAttributes(transform.position));
        ...
        {
            m_Started = false;
            movingplatform.stop(FMOD.Studio.STOP_MODE.IMMEDIATE);
