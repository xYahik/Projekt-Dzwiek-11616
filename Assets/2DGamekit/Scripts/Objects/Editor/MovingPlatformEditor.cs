...
namespace Gamekit2D
{
    ...
    public class MovingPlatformEditor : Editor
    {
        ...
        SerializedProperty m_PlatformMovingEvent;
        readonly GUIContent m_PlatformMovingEventContent = new GUIContent("FMOD PlatformMoving");
        private void OnEnable()
        {
            ...
            m_PlatformMovingEvent = serializedObject.FindProperty("PlatformMovingEvent");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_PlatformMovingEvent, m_PlatformMovingEventContent);
            EditorGUILayout.Separator();
            EditorGUILayout.Separator();
