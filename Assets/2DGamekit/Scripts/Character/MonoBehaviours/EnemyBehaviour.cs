...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        [FMODUnity.EventRef]
        public string MonsterSpitEvent = "";
        [FMODUnity.EventRef]
        public string MonsterDieEvent = "";
        [Header("Misc")]
        ...
        public void Shooting()
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot(MonsterSpitEvent, shootingOrigin.transform.position);
        }
        ...
        public void Die(Damager damager, Damageable damageable)
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot(MonsterDieEvent, transform.position);
            m_Dead = true;
