...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        //FMOD
        [FMODUnity.EventRef]
        public string PlayerStepsEvent = "";
        [FMODUnity.EventRef]
        public string PlayerJumpEvent = "";
        [FMODUnity.EventRef]
        public string PlayerSwordEvent = "";
        [FMODUnity.EventRef]
        public string PlayerLaserEvent = "";
        [FMODUnity.EventRef]
        public string PlayerFemaleEvent = "";
        [FMODUnity.EventRef]
        ...
        protected IEnumerator Shoot()
        {
            while (PlayerInput.Instance.RangedAttack.Held)
            {
                ...
                {
                    FMOD.Studio.EventInstance laser = FMODUnity.RuntimeManager.CreateInstance(PlayerLaserEvent);
                    laser.setParameterByName("Laser", 0);
                    laser.start();
                    laser.release();
                    SpawnBullet();
        ...
        public bool CheckForGrounded()
        {
            ...
            if (grounded)
            {
                ...
                {//only play the landing sound if falling "fast" enough (avoid small bump playing the landing sound)
                    ...
                    FMODUnity.RuntimeManager.PlayOneShot(PlayerJumpEvent, transform.position);
                    /*FMOD.Studio.EventInstance landing = FMODUnity.RuntimeManager.CreateInstance(PlayerJumpEvent);
                    landing.setParameterByName("Jumping", 1);
                    landing.start();
                    landing.release();*/
                }
            }
        ...
        public void OnHurt(Damager damager, Damageable damageable)
        {
            ...
            FMOD.Studio.EventInstance female = FMODUnity.RuntimeManager.CreateInstance(PlayerFemaleEvent);
            female.setParameterByName("Female", 0);
            female.start();
            female.release();
        ...
        {
            FMOD.Studio.EventInstance female = FMODUnity.RuntimeManager.CreateInstance(PlayerFemaleEvent);
            female.setParameterByName("Female", 1);
            female.start();
            female.release();
        ...
        public void EnableMeleeAttack()
        {
            ...
            FMOD.Studio.EventInstance sword = FMODUnity.RuntimeManager.CreateInstance(PlayerSwordEvent);
            sword.setParameterByName("Sword", 0);
            sword.start();
            sword.release();
        ...
        public void PlayFootstep()
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot(PlayerStepsEvent, transform.position);
        ...
        public void Respawn(bool resetHealth, bool useCheckpoint)
        {
            ...
            FMODUnity.RuntimeManager.PlayOneShot(SpawnEvent, transform.position);
