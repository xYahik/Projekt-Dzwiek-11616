...
namespace Gamekit2D
{
    ...
    public class PlayerCharacterEditor : Editor
    {
        ...
        SerializedProperty m_PlayerStepsEvent;
        SerializedProperty m_PlayerJumpEvent;
        SerializedProperty m_PlayerSwordEvent;
        SerializedProperty m_PlayerLaserEvent;
        SerializedProperty m_PlayerFemaleEvent;
        SerializedProperty m_SpawnEvent;
        ...
        readonly GUIContent m_PlayerStepsEventContent = new GUIContent("FMOD steps");
        readonly GUIContent m_PlayerJumpEventContent = new GUIContent("FMOD Jump");
        readonly GUIContent m_PlayerSwordEventContent = new GUIContent("FMOD Sword");
        readonly GUIContent m_PlayerLaserEventContent = new GUIContent("FMOD Laser");
        readonly GUIContent m_PlayerFemaleEventContent = new GUIContent("FMOD Female");
        readonly GUIContent m_SpawnEventContent = new GUIContent("FMOD Spawn");
        ...
        void OnEnable ()
        {
            ...
            m_PlayerStepsEvent = serializedObject.FindProperty("PlayerStepsEvent");
            m_PlayerJumpEvent = serializedObject.FindProperty("PlayerJumpEvent");
            m_PlayerSwordEvent = serializedObject.FindProperty("PlayerSwordEvent");
            m_PlayerLaserEvent = serializedObject.FindProperty("PlayerLaserEvent");
            m_PlayerFemaleEvent = serializedObject.FindProperty("PlayerFemaleEvent");
            m_SpawnEvent = serializedObject.FindProperty("SpawnEvent");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (m_AudioSettingsFoldout)
            {
                ...
                EditorGUILayout.PropertyField(m_PlayerStepsEvent, m_PlayerStepsEventContent);
                EditorGUILayout.PropertyField(m_PlayerJumpEvent, m_PlayerJumpEventContent);
                EditorGUILayout.PropertyField(m_PlayerSwordEvent, m_PlayerSwordEventContent);
                EditorGUILayout.PropertyField(m_PlayerLaserEvent, m_PlayerLaserEventContent);
                EditorGUILayout.PropertyField(m_PlayerFemaleEvent, m_PlayerFemaleEventContent);
                EditorGUILayout.PropertyField(m_SpawnEvent, m_SpawnEventContent);
            }
