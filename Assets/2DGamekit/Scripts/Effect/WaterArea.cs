...
namespace Gamekit2D
{
    ...
    public class WaterArea : MonoBehaviour
    {
        ...
        [FMODUnity.EventRef]
        public string WaterSplashEvent;
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            Debug.Log("test");
            FMODUnity.RuntimeManager.PlayOneShot(WaterSplashEvent, transform.position);
    ...
    public class WaterAreaEditor : Editor
    {
        ...
        protected SerializedProperty  m_WaterSplashEvent;
        ...
        private void OnEnable()
        {
            ...
            m_WaterSplashEvent = serializedObject.FindProperty("WaterSplashEvent");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_WaterSplashEvent);
