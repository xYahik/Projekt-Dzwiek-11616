...
#endif
{
    ...
    FMOD.Studio.EventInstance bossShield;
    [Space]
    ...
    void OnEnable()
    {
        ...
        round = 0;
        bossShield = FMODUnity.RuntimeManager.CreateInstance(BossEvent);
        ai = BT.Root();
        ai.OpenBranch(
            //First Round
    ...
    void ActivateShield()
    {
        ...
        bossShield.setParameterByName("Boss", 2);
        bossShield.start();
    ...
    void FireLaser()
    {
        ...
        FMOD.Studio.EventInstance boss = FMODUnity.RuntimeManager.CreateInstance(BossEvent);
        boss.setParameterByName("Boss", 0);
        boss.start();
        boss.release();
    ...
    void ActivateLightning()
    {
        ...
        FMOD.Studio.EventInstance boss = FMODUnity.RuntimeManager.CreateInstance(BossEvent);
        boss.setParameterByName("Boss", 1);
        boss.start();
        boss.release();
    ...
    void Cleanup()
    {
        ...
        FMOD.Studio.EventInstance boss = FMODUnity.RuntimeManager.CreateInstance(BossEvent);
        boss.setParameterByName("Boss", 3);
        boss.start();
        boss.release();
    ...
    public void ShieldDown()
    {
        ...
        bossShield.stop(FMOD.Studio.STOP_MODE.ALLOWFADEOUT);
        //bossShield.release();
